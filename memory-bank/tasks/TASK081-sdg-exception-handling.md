# [TASK081] - Narrow Exception Handling in sdg.py
...
## Original Request
Replace broad `except Exception as e:` patterns with specific exception handling in sdg.py.
...
## Implementation Plan
1. Identify all `except Exception` blocks in sdg.py (~4 occurrences)
